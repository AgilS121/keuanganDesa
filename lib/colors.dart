...
class AppColors {
  ...
  static const Color danger = Color(0xFFBC324A); // secondary
  static const Color third = Color(0xFFF5F5F5); // secondary
  static const Color fourth = Color(0xFF2D9CDB); // secondary
